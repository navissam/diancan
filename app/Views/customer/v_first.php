...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="mb-1 text-dark">欢迎光临</h1>
                    <p class="m-0">您已经注册成功，请您输入您的资料，以便日后送餐服务，谢谢</p>
                    <p class="m-0">Anda telah berhasil melakukan registrasi. Silahkan masukan data pribadi anda agar mempermudah pengantaran. Terima kasih</p>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
