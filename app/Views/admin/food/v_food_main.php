...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>平日菜肴信息管理 Manajemen Masakan Harian</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                ...
                <div class="col-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <a class="btn btn-success" href="<?= base_url('/admin/food/add'); ?>">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($rows as $row) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url('/admin/food/edit/' . base64_encode($row['foodID'])); ?>" class="btn btn-primary">
                                                    <i class="fas fa-edit"></i>
                                                    编辑 Edit
                                                </a>
                                                <form action="<?= base_url('/admin/food/ordinary/' . base64_encode($row['foodID'])); ?>" method="POST" class="d-inline">
                                                    <?= csrf_field(); ?>
                                                ...
                                                <form action="<?= base_url('/admin/food/switch'); ?>" method="POST" class="d-inline">
                                                    ...
                                                    <button type="submit" class="btn btn-info" onclick="return confirm('你确定要转成特别？ Anda yakin ingin mengganti menjadi spesial? ');">
                                                        <i class="fas fa-sync"></i>
                                                        转成特别 Ganti Menjadi Spesial
                                                    </button>
                                                </form>
                                            </td>
                                        </tr>
