            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="card  card-primary card-outline">
                        <form action="<?= base_url('/admin/food/update_s'); ?>" method="post" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" max="2147483647" class="form-control <?= ($validation->hasError('qty')) ? 'is-invalid' : ''; ?>" value="<?= old('qty') ? old('qty') : $row['qty']; ?>" name="qty" id="qty" placeholder="输入份数 Jumlah Porsi">
                                    <div class="invalid-feedback">
